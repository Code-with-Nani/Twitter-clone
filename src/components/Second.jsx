  ...
  return (
    <div className='main overflow-hidden'>
     ...
     <div className="all-posts ">
       ...
       <img className='img h-10 rounded-full w-10 object-cover' src={img} alt="" />
       <h2 className='pl-2 bold text-[15px]'>Muhammad Hanan</h2>
       <h2 className='pl-2 regular text-[15px] text-[#71767b]'>@HananUsman82357</h2>
       <h2 className='pl-2 regular text-[15px] text-[#71767b] hidden lg:block'>. 5h </h2>
       </div>
       <div className="text pl-16 md:-translate-y-4 regular">The new OpenAI logo is really on point</div>
       ...
       <div className="icons ml-[68px] my-3 cursor-pointer text-[#71767b] flex items-center justify-between mr-4">
        <span className='flex justify-center cursor-pointer items-center gap-1'><BiMessageRounded />2.7k</span>
        <span className='flex justify-center  cursor-pointeritems-center gap-1'><BiRepost className='text-xl'/>2.5k</span>
        <span className='flex justify-center cursor-pointer items-center gap-1'><CiHeart className='text-xl'/>3.4k</span>
        <span className='flex justify-center  cursor-pointeritems-center gap-1'><BiBarChart  className='text-xl'/>3.4k</span>
        <span className='flex justify-center  cursor-pointeritems-center gap-3'><BsBookmark /><LuShare /></span>
       </div>
       <div className="line w-full h-[1px] bg-[#2F3336] "></div>
       ...
       <div className="text pl-16 md:-translate-y-4 regular">Astro Db is 100% TypeScript</div>
       <div className="content border border-[#2F3336] ml-16 mr-6 rounded-xl">
       
        <img className='h-[300px] w-full rounded-xl object-cover' src={post4} alt="" />
       </div>
       <div className="icons ml-[68px] my-3 cursor-pointer text-[#71767b] flex items-center justify-between mr-4">
        <span className='flex justify-center cursor-pointer items-center gap-1'><BiMessageRounded />2.7k</span>
        <span className='flex justify-center  cursor-pointeritems-center gap-1'><BiRepost className='text-xl'/>2.5k</span>
       ...
       <div className="text pl-16 md:-translate-y-4 regular">The new look of Google login page</div>
       <div className="content border border-[#2F3336] ml-16 mr-6 rounded-xl">
       
        <img className='h-[300px] rounded-xl object-contain' src={post3} alt="" />
       </div>
       <div className="icons ml-[68px] my-3 cursor-pointer text-[#71767b] flex items-center justify-between mr-4">
        <span className='flex justify-center cursor-pointer items-center gap-1'><BiMessageRounded />2.7k</span>
        <span className='flex justify-center  cursor-pointeritems-center gap-1'><BiRepost className='text-xl'/>2.5k</span>
       ...
       <div className="text pl-16 md:-translate-y-4 regular">ChatGPT x Grok</div>
       <div className="content border border-[#2F3336] ml-16 mr-6 rounded-xl">
