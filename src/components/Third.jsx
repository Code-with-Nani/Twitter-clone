  ...
  return (
    <div className='main mt-1 ml-7 '>
      ...
      <div className="search flex justify-start items-center  regular ">
        ...
        <input type="text" placeholder='Search' className='outline-none bg-[#202327] w-[70%] rounded-r-full pl-3 py-[10px]' />
      </div>

      <div className="trends bg-[#202327] w-[80%] rounded-xl  mt-4 pt-2">
        <h2 className='medium text-[20px] font-[1000] pl-4 mb-3'>Trends For You</h2>
        ...
        <div className="item cursor-pointer py-2 hover:bg-[#2f3135] px-4 ">
           <h2 className='text-sm text-[#737679] regular flex justify-between'>Trending in Pakistan <IoIosMore className='text-[22px]'/></h2>
      ...
      <div className="follow bg-[#202327] w-[80%] rounded-xl  mt-4 pt-2">
        <h2 className='medium text-[20px] font-[1000] pl-4 mb-3'>Who to follow</h2>
        ...
        <div className="item py-2 hover:bg-[#2f3135] pl-4 pr-1  cursor-pointer">
           ...
           <div className='btn flex justify-between items-center'>
            <h2 className='text-sm text-[#737679] regular pl-3'>@HananUsman82357</h2>
            <div className="btn bg-[#D7DBDC] w-fit text-black medium px-3 py-[2px] rounded-full "><button>Follow</button></div>
           </div>

          
        </div>
        <div className="item cursor-pointer py-2 hover:bg-[#2f3135] px-5 rounded-b-xl">
           <h2 className='text-[#1d9bf0] regular flex justify-between'>Show more</h2>
        </div>
